...
public class Inanicion extends Carta {
	...
	public Inanicion() {
		super(0, 300, Habilidad.SIN_CARTAS_EN_LA_MANO, new Imagen(Recursos.INANICION_CARTA), false, 0, 0, "Esta carta no puede ser robada y no puede ser obtenida de forma común.\n "
